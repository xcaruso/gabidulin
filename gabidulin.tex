...
\begin{example}
Let $K = GF_7(t)$ the fraction field of univariate polynomial on the field at 7 elements. Let $\partial = \frac{\partial}{\partial t}$ a classic polynomial derivation. In this article, we will interesting in this red thread example : $K[X, \id, \partial] = GF_7(t)[X, \id, \frac{\partial}{\partial t}]$. 
\end{example}
